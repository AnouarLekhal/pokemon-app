...
var PokemonsService = /** @class */ (function () {
    ...
    PokemonsService.prototype.handelError = function (operation, result) {
    ...
    PokemonsService.prototype.getPokemons = function () {
        ...
        return this.http.get(this.pokemonsUrl)
            .pipe(operators_1.tap(function (_) { return _this.log("fetched pokemons"); }), operators_1.catchError(this.handelError("getPokemons", [])));
    };
    PokemonsService.prototype.searchPokemons = function (term) {
        ...
        var url = this.pokemonsUrl + "/?name=" + term;
        return this.http.get(url)
            .pipe(operators_1.tap(function (_) { return _this.log("found pokemons matching \"" + term + "\""); }), operators_1.catchError(this.handelError("searchPokemons", [])));
    };
    PokemonsService.prototype.deletePokemon = function (pokemon) {
        ...
        return this.http.delete(url, httpOptions)
            .pipe(operators_1.tap(function (_) { return _this.log("deleted pokemon id=" + pokemon.id); }), operators_1.catchError(this.handelError("deletePokemon")));
    };
    PokemonsService.prototype.updatePokemon = function (pokemon) {
        ...
        return this.http.put(this.pokemonsUrl, pokemon, httpOptions)
            .pipe(operators_1.tap(function (_) { return _this.log("update pokemon id=" + pokemon.id); }), operators_1.catchError(this.handelError("updatePokemon")));
    };
    ...
    PokemonsService.prototype.getPokemon = function (id) {
        ...
        return this.http.get(url)
            .pipe(operators_1.tap(function (_) { return _this.log("fetched pokemon id=" + id); }), operators_1.catchError(this.handelError("getPokemon id=" + id)));
